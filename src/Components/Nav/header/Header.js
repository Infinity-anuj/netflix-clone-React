...
function Header() {
    ...
    <div className = 'header_content'>
        ...
        <h4 className = 'header_desc'> "Yeon-du asks her best friend Bora to collect all the information she can about
          ...
          Bora, who turns seventeen, falls into the fever of first love."</h4>
